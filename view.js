...
// var refresh_button = "<button class='ui-button ui-widget ui-corner-all' onClick='window.location.reload();> Refresh </button>"
var refresh_button = "<button onClick='window.location.reload();' style='margin-left:20px; margin-top:20px; border-radius:8px; display: block;width: 25%; font-size: 16px;'>Revert Changes</button>"
$('#sidepanel').append(refresh_button);
